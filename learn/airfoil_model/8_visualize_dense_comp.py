...
filename = "/home/aa/vawt_env/learn/airfoil_model/compare_dense_val_loss.csv"
...
# val_loss = val_loss.iloc[:100]
# val_loss = val_loss.iloc[100:200]
fig = plt.figure()
...
# cross learn loss
filename = "/home/aa/vawt_env/learn/airfoil_model/compare_dense_learn_loss.csv"
df = pd.read_csv(filename, index_col='model_name')
# drop time column
df.drop('elapsed_time', axis=1, inplace=True)
df = df.T
