...
# models_list = [
#     model([Dense(128, input_dim=4, kernel_initializer='normal', activation='elu'),
#            Dense(3, kernel_initializer='normal', activation='linear')]),
#     model([Dense(32, input_dim=4, kernel_initializer='normal', activation='elu'),
#           Dense(32, kernel_initializer='normal', activation='elu'),
#           Dense(3, kernel_initializer='normal', activation='linear')]),
#     model([Dense(64, input_dim=4, kernel_initializer='normal', activation='elu'),
#           Dense(32, kernel_initializer='normal', activation='elu'),
#           Dense(3, kernel_initializer='normal', activation='linear')]),
#     model([Dense(128, input_dim=4, kernel_initializer='normal', activation='elu'),
...
epochs_max = 1000
batches_list = [4]
filename_learn = "cmp_act_learn_loss.csv"
filename_val = "cmp_act_val_loss.csv"
